...
public interface AngularParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterDescribe(AngularParser.DescribeContext ctx);
	/**
	 * Exit a parse tree produced by the {@code Describe}
	 * labeled alternative in {@link AngularParser#jasmineStatement}.
	 * @param ctx the parse tree
	 */
	void exitDescribe(AngularParser.DescribeContext ctx);
	/**
	 * Enter a parse tree produced by the {@code It}
	 * labeled alternative in {@link AngularParser#jasmineStatement}.
	 * @param ctx the parse tree
	 */
	void enterIt(AngularParser.ItContext ctx);
	/**
	 * Exit a parse tree produced by the {@code It}
	 * labeled alternative in {@link AngularParser#jasmineStatement}.
	 * @param ctx the parse tree
	 */
	void exitIt(AngularParser.ItContext ctx);
	/**
	 * Enter a parse tree produced by the {@code BeforeEach}
	 * labeled alternative in {@link AngularParser#jasmineStatement}.
	 * @param ctx the parse tree
	 */
	void enterBeforeEach(AngularParser.BeforeEachContext ctx);
	/**
	 * Exit a parse tree produced by the {@code BeforeEach}
	 * labeled alternative in {@link AngularParser#jasmineStatement}.
	 * @param ctx the parse tree
	 */
	void exitBeforeEach(AngularParser.BeforeEachContext ctx);
	/**
	 * Enter a parse tree produced by the {@code AfterEach}
	 * labeled alternative in {@link AngularParser#jasmineStatement}.
	 * @param ctx the parse tree
	 */
	void enterAfterEach(AngularParser.AfterEachContext ctx);
	/**
	 * Exit a parse tree produced by the {@code AfterEach}
	 * labeled alternative in {@link AngularParser#jasmineStatement}.
	 * @param ctx the parse tree
	 */
	void exitAfterEach(AngularParser.AfterEachContext ctx);
	/**
